<nav class="navbar navbar-expand-lg bg-body-white">
        <div class="container">
            ...
            <a class="navbar-brand" href="dashboard_resepsionis.php"> <img src="../asset/img/aloha4.png" alt="Admin Avatar" class="me-2"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <!-- <ul class="navbar-nav me-3">
                    <li class="nav-item mx-2">
                        <a class="nav-link" aria-current="page" href="dashboard_resepsionis.php">Dashboard</a>
                    </li>
                </ul> -->
                <ul class="navbar-nav">
